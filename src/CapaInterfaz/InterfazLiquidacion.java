...
public final class InterfazLiquidacion extends javax.swing.JInternalFrame {
...
//            interfaz.inhabilitar();
     ...
     //       interfaz.inhabilitarStockPantalon();
            interfaz.CrearTablaOferta();
               }

        public InterfazLiquidacion(File file, List<JTable> tabla, List<String> nom_files)  throws Exception {
        this.file = file;
        this.tabla = tabla;
    ...
    private void initComponents() {
        ...
        jLabel10.setText("                   PRODUCTOS PARA LIQUIDAR");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazLiquidacion().setVisible(true);
            }
        });
    }
